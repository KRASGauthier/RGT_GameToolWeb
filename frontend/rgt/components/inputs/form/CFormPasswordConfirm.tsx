import type { TFromDataType } from "./CForm";
...
function CFormPasswordConfirm({...other}: CFormPasswordConfirmProps) {
	return <CFormComponentConfirm defaultLabel="Password confirm" defaultTarget="password" errorMessage="Password is not matching" type="password" {...other} />
}
