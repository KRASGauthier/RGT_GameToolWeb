...
function CFormPassword({entry, ...other }: CFormPasswordProps) {
	...
	return <CFormComponent type="password" subMessages={subMessages} addEye subValueChanged={setValue} customCheck={check} entry={entry} {...other} />
}
