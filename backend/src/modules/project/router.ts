...
import { createProject, projectGet, projectGetAllFromUser, projectModify, projectModifyPicture } from "./controller.js";
...
projectRouter.patch(API_PROJECT_TARGET + API_PROJECT_TARGET_PICTURE, uploadInMemory.single("picture"), verifyProject, projectModifyPicture);
